...
- Code is authorized. UI art authored as code (pixel-art generators, shaders, procedural VFX) is authorized; generated-image art was rejected by the owner (2026-09-23); audio is not authorized yet.
...
Future: `game/audio`, `assets/export`. Godot resource paths and stable IDs (Joker/boss/item/shape IDs, save keys) must not be renamed casually: saves depend on them.
