...
_Last updated: 2026-09-23 — Endless run statistics, high-score repair, block finishes, and Fresh Board._
...
- [x] Endless finish picker: 12 selectable finishes with custom synthesized cues, plus unlockable animated Aurora/Starfall. Thirteen non-Classic finishes use 78 original pixel-art sprite faces generated by `tools/art/gen_skins.py`. Complete board clears switch to the bright Fresh Board look and music context.
...
- [ ] Human review of all finish cues and 14 looks, including color readability, reduced motion, and Fresh Board transitions on target hardware.
