...
const DEFS := {
	GRAND_SLAM: {"name": "Grand Slam", "badge": "SLAM!", "short": "x1.5 MULT, +2 MULT, +1 REFRESH, +3 CREDITS",
		"text": "Three pieces of the same family and the same color. Every placement from this tray gets +2 Mult and x1.5 Mult; you gain +1 Refresh this round and 3 Credits."},
	TRIPLETS: {"name": "Triplets", "badge": "TRIPLETS", "short": "+2 MULT EACH, +1 REFRESH",
		"text": "Three pieces of the same family. Every placement from this tray gets +2 Mult, and you gain +1 Refresh this round."},
	MONOCHROME: {"name": "Monochrome", "badge": "MONO", "short": "x1.5 MULT EACH",
		"text": "Three pieces of the same color (Prism counts as any color). Every placement from this tray gets x1.5 Mult."},
	...
	TWINS: {"name": "Twins", "badge": "TWINS", "short": "+30 CHIPS EACH",
		"text": "Exactly two pieces of the same family. Every placement from this tray gets +30 Chips."},
}
const ORDER := [GRAND_SLAM, TRIPLETS, MONOCHROME, STAIRCASE, TWINS]

const TWINS_CHIPS := 30
const TRIPLETS_MULT := 2.0
const MONOCHROME_X_MULT := 1.5
